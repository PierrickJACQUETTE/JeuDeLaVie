...
public class Test {
	...
	/**
	 * Attribut entier statique permettant d'identifier la regle a appliquer sur les cellules.
	 */
	...
	/**
	 * Accesseur statique permettant d'acceder à la reference de la grille courante.
	 * 
	 * @param i
	...
	/**
	 * Accesseur permettant de recuperer l'identifiant(entier) de la regle courante a utiliser pour la partie.
	 * 
	 * @return Entier identifiant de maniere unique la regle courante.
	 */
